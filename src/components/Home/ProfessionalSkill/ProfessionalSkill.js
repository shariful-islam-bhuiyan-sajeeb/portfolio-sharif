    ...
    <div className=" px-6" id="skill">
      ...
      <div className=" ">
        {/* <div className="md:px-0 px-5  ">
          <h3 className="text-4xl md:text-left flex lg:justify-start justify-center font-bold text-gray-700 lg:my-4 ">
            Forn-End Skill
          </h3>
          <div>
            <p className="text-xl font-semibold text-gray-600 mb-2">HTML-5</p>
            <div className="flex items-center text-[#2978CB] gap-2">
              <p className=" w-11/12">
                {" "}
                <ProgressBar className="" completed={completed} />
              </p>
        ...
        {/* <div className="md:px-0 px-5">
          <h3 className="text-4xl md:text-left flex lg:justify-start justify-center lg:my-4  lg:pt-0 pt-4 font-bold text-gray-700 ">
            Backend Skills
          </h3>
          <div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="font-semibold text-[#2978CB]">82%</p>
            </div>
          </div>
          <div>
            <p className="text-xl font-semibold text-gray-600 mb-2">
